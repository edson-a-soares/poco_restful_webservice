...
#ifndef Foundation_Application_AbstractConfiguration_INCLUDED
#define Foundation_Application_AbstractConfiguration_INCLUDED
...
namespace Application {
     ...
     */
    class AbstractConfiguration : public ConfigurationFileInterface
    {
    public:
        explicit AbstractConfiguration(std::string fileName);
