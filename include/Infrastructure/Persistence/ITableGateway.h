...
#ifndef Web_Service_Infrastructure_Persistence_ITable_Gateway_INCLUDED
...
namespace Persistence {
    ...
    /*!
     * It performs basic SQL operations in a database's tables.
     */
    class ITableGateway
    {
    public:
         ...
         */
        virtual ITableGateway & throwException(bool flag) = 0;
         ...
         * @return A reference to itself for allowing to chain this method.
         */
        virtual ITableGateway & table(const std::string & name) = 0;
         ...
         * @return A reference to itself for allowing to chain this method.
         */
        virtual ITableGateway & withColumn(const std::string & column) = 0;
         ...
         * @return A reference to itself for allowing to chain this method.
         */
        virtual ITableGateway & withColumn(const std::string & column, const std::string & value) = 0;
